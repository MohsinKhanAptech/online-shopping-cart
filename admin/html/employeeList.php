                                        ...
                                        <div class="card-header d-flex flex-column flex-sm-row border-top rounded-0 py-md-0">
                                            <div class="me-sm-5 me-3 ms-md-n2 pe-md-5 flex-grow-1">
                                                <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                                    <label class="w-100">
                                                        <input name="search" type="search" value="<?php echo $get_search ?>" onkeyup="employeeView(this.value);" class="form-control w-100" placeholder="Search Product" aria-controls="DataTables_Table_0" autocomplete="off">
