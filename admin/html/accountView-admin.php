                            ...
                            <div class="card mb-4">
                                <div class="card-header d-flex flex-sm-row flex-column align-items-center justify-content-between gap-4">
                                    ...
                                    <div class="flex-shrink-0 flex-grow-0 d-flex flex-column flex-sm-row gap-2">
                                        ...
                                        <button onclick="location.href='accountEdit-admin.php'" class="dt-button btn btn-secondary" type="button">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row flex-column flex-sm-row flex-grow-1 p-0 m-0">
                                        <button onclick="location.href='accountDelete-admin.php'" class="dt-button btn btn-danger flex-grow-1 w-auto my-4 mx-sm-5" type="button">
