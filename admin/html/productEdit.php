...
<?php
$title = "Product Edit | Admin Panel | OSC";
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4 text-capitalize"><span class="text-muted fw-light">Products /</span><span> Product Edit</span></h4>
                        <div class="card mb-4">
                            <div class="card-header">
                                <p class="card-title">Search the product name or id you want to edit.</p>
                        ...
                        <?php if (!empty($_GET["product_id"])) {
                            ...
                            <form action="productEditValid.php" method="post" id="productEditForm" enctype="multipart/form-data" autocomplete="off">
                                <div class="card mb-4">
                                    <div class="card-header d-flex flex-sm-row flex-column align-items-center justify-content-between gap-3">
                                        ...
                                        <div class="flex-shrink-1 flex-grow-0 flex-wrap d-flex flex-column flex-sm-row gap-2">
                                            <button onclick="location.href='productEdit.php'" class="dt-button btn btn-light" type="button">
                                    ...
                                    <div class="card-body">
                                        <div class="row mx-sm-4 my-sm-4 align-items-center">
                                            <div class="col-sm-4 col-12">
                                                <img id="uploadPreview" class="w-100 h-100 rounded" src="../../public/uploads/products/<?php echo $row["product_image"] ?>" alt="">
                                                <input type="file" name="product_image" id="product_image" class="form-control mt-3" onchange="PreviewImage();">
                                            </div>
                                            <div class="col-sm-8 col-12">
                                                <div class="row mx-3 mx-sm-0 mx-lg-5 justify-content-center">
                                                    ...
                                                    <p class="m-0 my-1 p-0 fs-5 text-capitalize">
                                                        ...
                                                        <input name="product_name" id="product_name" type="text" maxlength="100" class="d-block d-sm-inline-block fs-6 mx-2 mx-sm-0 form-control w-auto" value="<?php echo $row["product_name"] ?>" required />
                                                    </p>
                                                    <p class="m-0 my-1 p-0 fs-5 text-capitalize">
                                                        ...
                                                        <select name="product_category" id="product_category" class="d-block d-sm-inline-block fs-6 mx-2 mx-sm-0 form-select w-auto" required>
                                                            ...
                                                            <option <?php echo $row["product_category"] == "Sweets" ? "selected" : ""; ?> value="Sweets">Sweets</option>
                                                            <option <?php echo $row["product_category"] == "Toys" ? "selected" : ""; ?> value="Toys">Toys</option>
                                                        </select>
                                                    </p>
                                                    <p class="m-0 my-1 p-0 fs-5 text-capitalize">
                                                        <span style="display: inline-block; width: 6em;">Price:</span>
                                                        <input type="number" name="product_price" id="product_price" class="d-block d-sm-inline-block fs-6 mx-2 mx-sm-0 form-control w-auto" value="<?php echo $row["product_price"] ?>" step="0.01" maxlength="65" required>
                                                    </p>
                                                    <p class="m-0 my-1 p-0 fs-5 text-capitalize">
                                                        <span style="display: inline-block; width: 6em;">Stock:</span>
                                                        <input type="number" name="product_stock" id="product_stock" class="d-block d-sm-inline-block fs-6 mx-2 mx-sm-0 form-control w-auto" value="<?php echo $row["product_stock"] ?>" maxlength="10" required>
                                                    </p>
                                                    <p class="m-0 my-1 p-0 fs-5 text-capitalize">
                                        ...
                                        <div class="row mx-1 mx-sm-5 mt-2">
                                            ...
                                            <p class="row m-0 my-1 p-0 fs-5">
                                                ...
                                                <textarea name="product_description" id="product_description" rows="5" class="fs-6 mx-2 mx-sm-3 mt-sm-2 mt-1 p-3 form-control flex-grow-1 w-auto" style="resize: none;" maxlength="1000" required><?php echo $row["product_description"] ?></textarea>
...
<script>
    function productView(search, type = "edit") {
        if (search.length == 0) {
