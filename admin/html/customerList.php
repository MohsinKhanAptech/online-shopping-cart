...
$customer_count_querry = preg_replace("/ ORDER BY `timestamp` DESC LIMIT $limit OFFSET $offset/i", "", $customer_count_querry);
                                            ...
                                            <div class="d-flex justify-content-start justify-content-md-end align-items-baseline">
                                                <div class="dt-action-buttons d-flex align-items-start align-items-md-center justify-content-sm-center mb-3 mb-sm-0">
                                                    ...
                                                    <div class="dt-buttons d-flex flex-wrap">
                                                        <button onclick="location.href='customerAdd.php'" class="dt-button add-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button"><span><i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add customer</span></span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
