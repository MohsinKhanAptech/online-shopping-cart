...
<?php
$title = "Order Remove | Admin Panel | OSC";
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4 text-capitalize"><span class="text-muted fw-light">Orders /</span><span> Order Remove</span></h4>
                        <div class="card mb-4">
                            <div class="card-header">
                                <p class="card-title">Search the order name or id you want to delete.</p>
