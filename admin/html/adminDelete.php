...
<?php
$title = "Admin Remove | Admin Panel | OSC";
$currentPage = "adminDelete";
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4 text-capitalize"><span class="text-muted fw-light">Admins /</span><span> Admin Remove</span></h4>
                        <div class="card mb-4">
                            <div class="card-header">
                                <p class="card-title">Search the admin name or id you want to delete.</p>
                        ...
                        <?php if (!empty($_GET["admin_id"])) {
                            ...
                            <div class="card mb-4">
                                <div class="card-header d-flex flex-sm-row flex-column align-items-center justify-content-between gap-4">
                                    ...
                                    <form action="adminDeleteValid.php" method="post">
                                        <div class="flex-shrink-0 flex-grow-0 d-flex flex-column flex-sm-row gap-2">
                                            <input type="hidden" name="admin_id" value="<?php echo $admin_id ?>">
                                            <button onclick="location.href='adminDelete.php'" class="dt-button btn btn-primary" type="button">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="adminDeleteValid.php" method="post">
                                        ...
                                        <div class="row flex-column flex-sm-row flex-grow-1 p-0 m-0">
                                            <button onclick="location.href='adminDelete.php'" class="dt-button btn btn-primary flex-grow-1 w-auto my-4 mx-sm-5" type="button">
                                                <span><i class="bx bx-x-circle me-1"></i><span>Cancel</span></span>
                                            </button>
...
<script>
    function adminView(search, type = "delete") {
        if (search.length == 0) {
