...
<?php
$title = "Order Edit | Admin Panel | OSC";
$currentPage = "orderEdit";
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4 text-capitalize"><span class="text-muted fw-light">Orders /</span><span> Order Edit</span></h4>
                        <div class="card mb-4">
                            <div class="card-header">
                                <p class="card-title">Search the order id you want to edit.</p>
                        ...
                        <?php if (!empty($_GET["order_id"])) {
                            ...
                            <form action="orderEditValid.php" method="post" id="orderEditForm" autocomplete="off">
                                <div class="card mb-4">
                                    <div class="card-header d-flex flex-sm-row flex-column align-items-center justify-content-between gap-4">
                                        ...
                                        <div class="flex-shrink-0 flex-grow-0 d-flex flex-column flex-sm-row gap-2">
                                            <button onclick="location.href='orderEdit.php'" class="dt-button btn btn-light" type="button">
                                        ...
                                        <div class="row mx-1 mx-sm-5">
                                            ...
                                            <p class="m-0 my-1 p-0 fs-5 text-capitalize">
                                                ...
                                                <select name="order_status" id="order_status" class="form-select d-block d-sm-inline-block w-auto fs-6 mx-2 mx-sm-0">
                                                    ...
                                                    <option <?php echo $row["order_status"] == "Pending" ? "selected" : ""; ?> value="Pending">Pending</option>
                                                    <option <?php echo $row["order_status"] == "Processing" ? "selected" : ""; ?> value="Processing">Processing</option>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row flex-column flex-sm-row flex-grow-1 p-0 m-0">
                                            <button onclick="location.href='orderEdit.php'" class="dt-button btn btn-secondary flex-grow-1 w-auto my-4 mx-sm-5" type="button">
                                                <span><i class="bx bx-x-circle me-1"></i><span>Discard</span></span>
                                            </button>
...
<script>
    function orderView(search, filter, type = "edit") {
        if (search.length == 0) {
