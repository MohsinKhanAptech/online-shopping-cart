...
<?php
$title = "Employee View | Admin Panel | OSC";
$currentPage = "employeeView";
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4 text-capitalize"><span class="text-muted fw-light">Employees /</span><span> Employee View</span></h4>
                        <div class="card mb-4">
                            <div class="card-header">
                                <p class="card-title">Search the employee name or id you want to view.</p>
                            ...
                            <div class="card mb-4">
                                <div class="card-header d-flex flex-sm-row flex-column align-items-center justify-content-between gap-4">
                                    ...
                                    <div class="flex-shrink-0 flex-grow-0 d-flex flex-column flex-sm-row gap-2">
                                        <button onclick="location.href='employeeEdit.php?employee_id=<?php echo $row['employee_id'] ?>'" class="dt-button btn btn-secondary" type="button">
                                            <span><i class="bx bx-edit me-1"></i><span>Edit Employee</span></span>
                                        </button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row flex-column flex-sm-row flex-grow-1 p-0 m-0">
                                        ...
                                        <button onclick="location.href='employeeEdit.php?employee_id=<?php echo $row['employee_id'] ?>'" class="dt-button btn btn-secondary flex-grow-1 w-auto my-4 mx-sm-5" type="button">
                                            <span><i class="bx bx-edit me-1"></i><span>Edit Employee</span></span>
                                        </button>
                                    </div>
                                </div>
...
<script>
    function employeeView(search, type = "view") {
        if (search.length == 0) {
