...
<body>
    ...
    <form action="signupValid.php" method="post" enctype="multipart/form-data">
        ...
        <div><input type="text" name="user_name" id="user_name"></div>
        <div><label for="user_email">Email</label></div>
        <div><input type="email" name="user_email" id="user_email"></div>
        <div><label for="user_password">Password</label></div>
        <div><input type="password" name="user_password" id="user_password"></div>
        <div><label for="user_contact">Contact</label></div>
        <div><input type="tel" name="user_contact" id="user_contact"></div>
        <div><label for="user_address">Address</label></div>
        <div><textarea name="user_address" id="user_address" cols="30" rows="10"></textarea></div>
        <div><label for="user_image">Image</label></div>
        <div><input type="file" name="user_image" id="user_image"></div>
