...
if (isset($_POST["submit"])) {
    ...
    $querry = "INSERT INTO `products`(`product_name`, `product_description`, `product_category`, `product_price`, `product_stock`, `product_video`, `product_image_1`, `product_image_2`, `product_image_3`, `product_image_4`, `product_image_5`) VALUES ('$product_name','$product_description','$product_category','$product_price','$product_stock','$product_video','$product_image_1','$product_image_2','$product_image_3','$product_image_4','$product_image_5')";
    $dup_name_check = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM `products` WHERE `product_name` = '$product_name'"));
